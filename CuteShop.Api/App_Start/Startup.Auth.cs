...
[assembly: OwinStartup(typeof(CuteShop.Api.App_Start.Startup))]

namespace CuteShop.Api.App_Start
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(CuteShopDbContext.Create);
        ...
        {
            var userStore = new UserStore<ApplicationUser>(context.Get<CuteShopDbContext>());
